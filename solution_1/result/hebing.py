...
dfuserinapp=pd.read_csv("%s/user_installedapps.csv"%data_root)
...
#dfTrain = pd.merge(dfTrain, dfuserinapp, on="userID")
...
enc = OneHotEncoder()
feats = ["creativeID", "adID", "camgaignID", "advertiserID", "appID", "appPlatform","userID","age","gender","education"]
...
for i,feat in enumerate(feats):
    ...
    if i == 0:
        ...
        X_train, X_test = sparse.hstack((X_train, x_train)), sparse.hstack((X_test, x_test))#横向合并所有的ad广告
    print(X_test)
